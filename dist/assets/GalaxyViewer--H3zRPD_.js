...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function ic(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:el(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function rc(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:el(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Zv(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Au?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===vh?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Mn&&(e="SHADOWMAP_TYPE_VSM"),e}function Jv(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Gi:case Wi:e="ENVMAP_TYPE_CUBE";break;case Oa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qv(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Wi:e="ENVMAP_MODE_REFRACTION";break}return e}function e_(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Hs:e="ENVMAP_BLENDING_MULTIPLY";break;case Gh:e="ENVMAP_BLENDING_MIX";break;case Wh:e="ENVMAP_BLENDING_ADD";break}return e}function t_(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function n_(n,e,t,i){const r=n.getContext(),a=t.defines;let o=t.vertexShader,s=t.fragmentShader;const l=Zv(t),c=Jv(t),u=Qv(t),f=e_(t),d=t_(t),p=Gv(t),g=Wv(a),v=r.createProgram();let m,h,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(dr).join(`
`)),o=Ss(o),o=pc(o,t),o=mc(o,t),s=Ss(s),s=pc(s,t),s=mc(s,t),o=gc(o),s=gc(s),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
Object.defineProperty(this, '{var}', {
  ...
  Vector.prototype.reset = function () {
    ${t("this.{var} = ",{join:""})}0;
  };`}var Ly=Pr.exports,qn={exports:{}};const fl=Qi,Vn=bf;qn.exports=Dy;qn.exports.generateQuadTreeFunctionBody=Tf;qn.exports.getInsertStackCode=Lf;qn.exports.getQuadNodeCode=Pf;qn.exports.isSamePosition=Af;qn.exports.getChildBodyCode=Rf;qn.exports.setChildBodyCode=Cf;function Dy(n){let e=Tf(n);return new Function(e)()}function Tf(n){let e=fl(n),t=Math.pow(2,n);return`
${Lf()}
${Pf(n)}
${Af(n)}
${Rf(n)}
...
`)}}function Af(n){let e=fl(n);return`
...
`)}}function Pf(n){let e=fl(n),t=Math.pow(2,n);var i=`
function QuadNode() {
...
`}var Iy=qn.exports,hl={exports:{}};hl.exports=Ny;hl.exports.generateFunctionBody=Df;const Oy=Qi;function Ny(n){let e=Df(n);return new Function("bodies","settings","random",e)}function Df(n){let e=Oy(n);return`
  var boundingBox = {
...
`}var Uy=hl.exports,dl={exports:{}};const Fy=Qi;dl.exports=By;dl.exports.generateCreateDragForceFunctionBody=If;function By(n){let e=If(n);return new Function("options",e)}function If(n){return`
...
`}var ky=dl.exports,pl={exports:{}};const zy=Qi;pl.exports=Hy;pl.exports.generateCreateSpringForceFunctionBody=Of;function Hy(n){let e=Of(n);return new Function("options","random",e)}function Of(n){let e=zy(n);return`
...
`}var Vy=pl.exports,ml={exports:{}};const Gy=Qi;ml.exports=Wy;ml.exports.generateIntegratorFunctionBody=Nf;function Wy(n){let e=Nf(n);return new Function("bodies","timeStep","adaptiveTimeStepWeight",e)}function Nf(n){let e=Gy(n);return`
